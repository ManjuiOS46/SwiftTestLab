...
file, so verifying one means wrapping it in a throwaway package — your file as a
module named `Subject`, the generated test as its test target — and building that.
